...
from ai_utils import generate_quiz_from_text, extract_text_from_pdf, get_fallback_questions
...
class TestAIUtils:
    ...
    def test_generate_quiz_from_text_success(self, mock_openai):
        ...
        # Call the function
        result = generate_quiz_from_text("France is a country in Europe. Paris is its capital.")
