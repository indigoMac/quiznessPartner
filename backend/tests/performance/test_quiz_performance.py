...
class TestPerformance:
    ...
    def test_quiz_generation_performance(
        self, mock_generate_quiz, client: TestClient, auth_headers
    ):
    ...
    def test_quiz_retrieval_performance(self, mock_get_quiz, client: TestClient):
        ...
        for size in quiz_sizes:
            ...
            assert (
                response_time < max_expected_time
    ...
    def test_memory_usage_with_large_quiz(self, client: TestClient, auth_headers):
        ...
        with patch("main.generate_quiz_from_text") as mock_generate:
            ...
            assert (
                response_time < 5.0
            ), f"Large quiz generation took {response_time:.3f}s"
    ...
    def test_database_query_performance(
        ...
        ), f"Average quiz retrieval time {avg_retrieval_time:.3f}s is too slow"
