...
class TestIntegrationWorkflow:
    ...
    def test_complete_quiz_workflow(self, mock_generate_quiz, mock_extract_text, 
        ...
        questions = db_session.query(Question).filter(Question.quiz_id == int(quiz_id)).all()
    ...
    def test_quiz_with_authentication_flow(self, client: TestClient, 
    ...
    def test_database_persistence(self, client: TestClient, db_session: Session, 
                                auth_headers: dict):
