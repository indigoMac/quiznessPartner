...
class QuiznessUser(HttpUser):
    ...
    def get_quiz(self):
        ...
        if self.quiz_ids:
            ...
            with self.client.get(f"/api/v1/quiz/{quiz_id}", catch_response=True) as response:
    ...
    def submit_quiz_answer(self):
        ...
        if self.quiz_ids:
            ...
            if quiz_response.status_code == 200:
                ...
                self.client.post("/api/v1/submit-answer", json={
                    "quiz_id": int(quiz_id),
                    "answers": answers
                })
...
class AdminUser(HttpUser):
    ...
    def create_large_quiz(self):
        ...
        payload = {
            "content": "This is a comprehensive study material covering multiple topics " * 10,
